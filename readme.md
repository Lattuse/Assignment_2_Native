...
### How to run:
1. Download ZIP project or clone the project using
```bash git clone https://github.com/Lattuse/Assignment_2_Native.git'```
3. Open project in Intellij IDEA / other IDE
